<?php
// ═══════════════════════════════════════════════════════════
//  FILE: backend/database/migrations/2026_07_11_000002_create_events_table.php
...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('events', function (Blueprint $table) {
            ...
            $table->dateTime('start_datetime'); // when the event begins
            $table->dateTime('end_datetime');   // when the event ends
            $table->string('location', 255);    // venue / address
