...
const AlumniRegisterPage = lazy(
  () => import("../pages/auth/AlumniRegisterPage"),
);
...
const DepartmentsListPage = lazy(
  () => import("../pages/admin/departments/DepartmentsListPage"),
);
const DepartmentDetailPage = lazy(
  () => import("../pages/admin/departments/DepartmentDetailPage"),
);
const GraduateImportPage = lazy(
  () => import("../pages/admin/graduates/GraduateImportPage"),
);
const GraduatesListPage = lazy(
  () => import("../pages/admin/graduates/GraduatesListPage"),
);
const GraduateDetailPage = lazy(
  () => import("../pages/admin/graduates/GraduateDetailPage"),
);
const GraduateTrashPage = lazy(
  () => import("../pages/admin/graduates/GraduateTrashPage"),
);
const ImportHistoryPage = lazy(
  () => import("../pages/admin/graduates/ImportHistoryPage"),
);
const VerificationLogsPage = lazy(
  () => import("../pages/admin/verification/VerificationLogsPage"),
);
const AnalyticsDashboardPage = lazy(
  () => import("../pages/admin/analytics/AnalyticsDashboardPage"),
);
const NotificationsPage = lazy(
  () => import("../pages/admin/notifications/NotificationsPage"),
);
const AnnouncementListPage = lazy(
  () => import("../pages/admin/announcements/AnnouncementListPage"),
);
const AnnouncementFormPage = lazy(
  () => import("../pages/admin/announcements/AnnouncementFormPage"),
);
...
const JobPostingListPage = lazy(
  () => import("../pages/admin/jobs/JobPostingListPage"),
);
const JobPostingFormPage = lazy(
  () => import("../pages/admin/jobs/JobPostingFormPage"),
);
const SettingsPage = lazy(() => import("../pages/admin/settings/SettingsPage"));

// ─── Alumni pages ────────────────────────────────────────
const AlumniDashboardPage = lazy(
  () => import("../pages/alumni/dashboard/AlumniDashboardPage"),
);
const AlumniProfilePageView = lazy(
  () => import("../pages/alumni/profile/AlumniProfilePage"),
);
const AlumniEmploymentPage = lazy(
  () => import("../pages/alumni/employment/AlumniEmploymentPage"),
);
const AlumniBoardExamPage = lazy(
  () => import("../pages/alumni/board-exam/AlumniBoardExamPage"),
);
const AlumniAnnouncementsPage = lazy(
  () => import("../pages/alumni/announcements/AlumniAnnouncementsPage"),
);
const AlumniNotificationsPage = lazy(
  () => import("../pages/alumni/notifications/AlumniNotificationsPage"),
);
const AlumniCareerCenterPage = lazy(
  () => import("../pages/alumni/jobs/AlumniCareerCenterPage"),
);
...
const AlumniInboxPage = lazy(
  () => import("../pages/alumni/messages/AlumniInboxPage"),
);
const AlumniConversationPage = lazy(
  () => import("../pages/alumni/messages/AlumniConversationPage"),
);
const AlumniDirectoryPage = lazy(
  () => import("../pages/alumni/directory/AlumniDirectoryPage"),
);
const AlumniPublicProfilePage = lazy(
  () => import("../pages/alumni/directory/AlumniPublicProfilePage"),
);
const AlumniSettingsPage = lazy(
  () => import("../pages/alumni/settings/AlumniSettingsPage"),
);
        ...
        <Route element={<ProtectedRoute />}>
          <Route element={<RoleGuard roles={["alumni"]} />}>
            <Route path="/alumni" element={<AlumniLayout />}>
              ...
              <Route
                path="announcements"
                element={<AlumniAnnouncementsPage />}
              />
              <Route
                path="notifications"
