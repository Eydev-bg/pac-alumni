              ...
              <div className="space-y-3">
                {board_exam_records.map((r) => (
                  ...
                  >
                    ...
                    {/* proof_file arrives from the API already resolved to a
                        servable URL (signed for cloud disks). */}
                    <div className="mt-2.5 pt-2.5 border-t border-white/[0.06]">
                      {r.proof_file ? (
                        <button
                          ...
                          className="inline-flex items-center gap-1.5 px-2.5 py-1 text-[11px] font-medium text-[#c8a84e] border border-[#c8a84e]/30 rounded-lg hover:bg-[#c8a84e]/10 hover:border-[#c8a84e]/50 transition-colors"
                        >
