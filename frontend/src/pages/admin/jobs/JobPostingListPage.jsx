  ...
  if (logo) {
    return (
      <img
        src={storageUrl(logo)}
        alt={name}
        className="w-8 h-8 rounded-lg object-cover border border-white/[0.08] flex-shrink-0"
      />
    );
  }
  return (
    <span className="w-8 h-8 rounded-lg bg-white/[0.06] border border-white/[0.08] flex items-center justify-center flex-shrink-0">
  ...
  const columns = [
    {
      ...
      render: (a) => (
        <div className="flex items-center gap-2.5">
          ...
          <span className="font-medium text-slate-200 max-w-[180px] truncate whitespace-nowrap">
            {a.company_name}
          </span>
        </div>
      ),
    },
    {
      ...
      cellClassName: "whitespace-nowrap",
      render: (a) => (
        <span className="text-sm text-slate-300 max-w-[180px] truncate inline-block whitespace-nowrap">
          {a.job_position}
        </span>
      ),
    },
    {
      ...
      cellClassName: "whitespace-nowrap",
      render: (a) => (
        <span className="inline-flex items-center gap-1.5 max-w-[160px] text-sm text-slate-300 whitespace-nowrap">
    ...
    },
    {
      key: "deadline",
      header: "Deadline",
      cellClassName: "text-xs text-slate-400 whitespace-nowrap",
      render: (a) =>
