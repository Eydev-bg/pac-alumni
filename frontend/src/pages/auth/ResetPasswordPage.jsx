        ...
        <div className="w-full bg-white/[0.92] backdrop-blur-2xl border border-white/50 rounded-2xl px-7 pt-8 pb-6 shadow-[0_16px_48px_rgba(0,0,0,0.12)]">
          ...
          {success ? (
            ...
            <div className="text-center py-2">
              ...
              <p className="text-[0.78rem] text-slate-400 mb-1 leading-relaxed">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-3">
                  ...
                  <input
                    ...
                    required
                    autoComplete="email"
                    className="w-full px-3 py-2 border border-slate-300 rounded-lg text-[0.8rem] text-slate-800 placeholder:text-slate-400 bg-white/70 outline-none transition-all duration-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/15 focus:bg-white"
                  />
                </div>
