...
export default function AlumniConversationPage() {
  ...
  return (
    ...
    <div className="-m-4 sm:-m-6 lg:-m-8 h-[calc(100dvh-4rem)] overflow-hidden bg-white dark:bg-slate-800 sm:bg-[#f5f7fb] sm:dark:bg-slate-900">
      <div className="h-full bg-white dark:bg-slate-800 rounded-none sm:rounded-2xl overflow-hidden sm:border border-slate-200 dark:border-slate-700 sm:m-4 sm:h-[calc(100dvh-2rem)]">
        <ConversationThread
