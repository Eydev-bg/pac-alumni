...
const PRIMARY_BTN =
  "inline-flex items-center gap-2 rounded-[9px] bg-gradient-to-r from-gold-500 to-gold-300 px-5 py-2.5 text-[13px] font-semibold text-navy-800 shadow-sm transition hover:brightness-105 focus:outline-none focus:ring-2 focus:ring-gold-300/60";
const SECONDARY_BTN =
  "inline-flex items-center gap-2 rounded-[9px] border border-white/[0.28] px-[18px] py-2.5 text-[13px] font-medium text-[#e6ecf7] transition hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-white/40";
      ...
      <div className="mx-auto max-w-6xl">
        <div className="flex flex-col items-center gap-8 md:flex-row md:gap-10">
          ...
          <div className="md:flex-[1.25]">
            <p className="mb-2 text-[10px] font-semibold uppercase tracking-[0.15em] text-gold-500">
            ...
            >
              Stay connected with{" "}
              <em className="not-italic text-gold-300">Philippine Advent College</em>{" "}
              alumni
            </h1>
            <p className="my-4 max-w-xl text-[13px] leading-[1.65] text-[#c3cee2] sm:text-sm">
            ...
            <p className="mt-3.5 flex items-center gap-1.5 text-[11px] text-[#8ea0c4]">
          ...
          <div className="w-full md:flex-1">
            <div className="relative overflow-hidden rounded-xl border border-gold-500/20 shadow-[0_16px_48px_rgba(0,0,0,0.35)]">
              <img
                src="/campus-bg.jpg"
